...
public class Driver {
  public static void main(String[] args) {
    ...
    String text = "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"
        ...
        + "eeeeeeeee"
        + "fffff";
     text = Util.loadFile(Constants.ALICE);
     text = Util.loadFile(Constants.MOBY_DICK);
     text = Util.loadFile(Constants.PIRATE);
    ...
    System.out.println("Percentage of bits saved " + ((double) text.length() * Constants.BITESIZE - bits.length())/(double)(text.length() * Constants.BITESIZE)*100);
    System.out.println("\nAll tests passed...");
  }
}
